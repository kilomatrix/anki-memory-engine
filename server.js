...
split：用词缀词根等分拆（解释用到哪些词缀或词根即可，不要谐音联想不要啰嗦，格式如：ex-（向外）+词根 trem（颤抖）+后缀 -e ）
memory：谐音联想法（单词用谐音记忆，如：爱克斯追梦，太极端的，用中文谐音串成好记、有趣、贴合词义的一句话，越短越好，画面感强，小学生能秒记。）
sentence：适合小学阶段的英语造句练习，提供一句简单英文句子（结构简单，单词尽量少，5-8个单词为宜，句子中单词均在中国国内小学单词表内）
{
  "word": "${word}",
  "split": "用词缀词根等拆分记忆",
  "association": "联想故事",
